...
##### <p id="debugOfMultithreading">*在重现问题之前，首先要学会多线程debug。可以参考[ idea 多线程debug](https://blog.csdn.net/kevindai007/article/details/71412324)</p>
...
### <id name="serializationAttack">序列化对单例模式的破坏</a>
