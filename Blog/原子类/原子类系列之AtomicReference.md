...
## 总结：
通过本篇文章可以学习AtomicStampedReference和AtomicMarkableReference类的使用场景和源码，更为重要的是知道JDK是如何通过原子类解决ABA隐患的。日常开发中需要对象原子化操作可以从AtomicReference、AtomicStampedReference和AtomicMarkableReference类中考虑，如果担心出现ABA隐患
