...
第9行AtomicIntegerFieldUpdater调用newUpdater(Class<U> class, String fieldName)静态方法创建AtomicIntegerFieldUpdater对象，通过AtomicIntegerFieldUpdater的对象就可以保证对象属性为参数fieldName的原子性，示例中为Score类中的totalScore属性。
